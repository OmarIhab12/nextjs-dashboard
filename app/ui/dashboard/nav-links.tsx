      ...
      {visible.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              'flex h-[48px] flex-none items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-red-50 hover:text-red-700 md:mb-1 md:w-full md:justify-start md:p-2 md:px-3',
              {
